...
Feedstock for [eic-smear](https://github.com/eic/eic-smear) — part of [hep-forge](https://anaconda.org/hep-forge).
...
```bash
conda install -c hep-forge -c conda-forge eic-smear
```
